About opentelemetry-instrumentation-openai-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-openai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-openai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-openai
# for installing globally
pixi global install opentelemetry-instrumentation-openai
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-openai` available on your platform:
...
```
pixi search opentelemetry-instrumentation-openai --channel conda-forge
```
